...
def detect(opt, blah, save_img=False):
    source, weights, view_img, save_txt, imgsz = blah, opt.weights, opt.view_img, opt.save_txt, opt.img_size
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf-thres', type=float,
                        default=0.10, help='object confidence threshold')
    parser.add_argument('--iou-thres', type=float,
                        default=0.10, help='IOU threshold for NMS')
